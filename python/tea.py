...
correct = pd.DataFrame(
    {"cup": np.arange(1, 9), "guess": np.concatenate((range(1, 5), np.repeat(0, 4)))}
)

combo = pd.DataFrame(
    np.array(list(combinations(correct["cup"], 4))),
...
combo["correct"] = 0
combo.loc[
    (combo.cup_1 == 1) & (combo.cup_2 == 2) & (combo.cup_3 == 3) & (combo.cup_4 == 4),
    "correct",
] = 1
