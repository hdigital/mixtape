...
def gen_cluster(param=(0.1, 0.5), n=1000, n_cluster=50, rho=0.5):
...
def cluster_sim(param=(0.1, 0.5), n=1000, n_cluster=50, rho=0.5, cluster_robust=False):
...
def run_cluster_sim(
    n_sims=1000, param=(0.1, 0.5), n=1000, n_cluster=50, rho=0.5, cluster_robust=False
):
    res = [
        cluster_sim(
            param=param,
...
sim_params = [0.4, 0]  # beta1 = 0: no effect of x on y
sim_nocluster = run_cluster_sim(
    n_sims=1000, param=sim_params, rho=0, cluster_robust=False
)
