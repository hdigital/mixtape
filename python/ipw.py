...
logit_nsw = smf.glm(
    formula="""treat ~ age + age**2 + age**3 + educ + educ**2 + 
...
nsw_dw_cpscontrol["y1"] = (
    nsw_dw_cpscontrol.treat * nsw_dw_cpscontrol.re78 / nsw_dw_cpscontrol.pscore
)
nsw_dw_cpscontrol["y0"] = (
    (1 - nsw_dw_cpscontrol.treat)
    * nsw_dw_cpscontrol.re78
    / (1 - nsw_dw_cpscontrol.pscore)
)
...
nsw_dw_trimmed = nsw_dw_trimmed[nsw_dw_trimmed.pscore.between(0.1, 0.9)]
N = nsw_dw_trimmed.shape[0]

nsw_dw_trimmed["y1"] = (
    nsw_dw_trimmed.treat * nsw_dw_trimmed.re78 / nsw_dw_trimmed.pscore
)
nsw_dw_trimmed["y0"] = (
    (1 - nsw_dw_trimmed.treat) * nsw_dw_trimmed.re78 / (1 - nsw_dw_trimmed.pscore)
)
