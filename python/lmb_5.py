...
lm_1 = lm_robust(
    "score ~ lagdemocrat*demvoteshare_c + lagdemocrat*demvoteshare_sq", data=lmb_data
)
lm_2 = lm_robust(
    "score ~ democrat*demvoteshare_c + democrat*demvoteshare_sq", data=lmb_data
)
lm_3 = lm_robust(
    "democrat ~ lagdemocrat*demvoteshare_c + lagdemocrat*demvoteshare_sq", data=lmb_data
)
print(
